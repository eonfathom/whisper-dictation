...
echo "    VOX_MODEL=base     (tiny, base, small, medium, large-v3)"
echo "    VOX_LANG=en        (language code or empty for auto-detect)"
echo "    VOX_DEVICE=cuda    (cuda or cpu)"
echo "    VOX_COMPUTE=float16 (float16, int8, etc.)"
echo ""
